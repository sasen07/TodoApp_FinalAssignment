package com.example.TodoAppList_final;
...
import com.example.TodoAppList_final.model.ETodo;
import com.example.TodoAppList_final.viewmodel.TodoViewModel;
...
public class EditTodoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtTitle=rootView.findViewById(R.id.title_id);
        txtDescription=rootView.findViewById(R.id.description_id);
        txtDate=rootView.findViewById(R.id.date_id);
        ...
        chkIsCompleted=rootView.findViewById(R.id.complete_id);
        btnSave=rootView.findViewById(R.id.save_id);
        btnCancel=rootView.findViewById(R.id.cancelfrag_id);
        txtDate=rootView.findViewById(R.id.date_id);
